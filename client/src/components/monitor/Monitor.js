...
class Monitor extends Component{
   ...
   delOrder(product){
      let findOrder = this.state.orders.find(orders => orders.product.productId == product.productId);
      let resultOrder = this.state.orders.filter(orders => orders.product.productId != product.productId);
